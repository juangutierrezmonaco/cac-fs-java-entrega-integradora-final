...
<body>
	...
	boolean result = t_dao.updateTicket(ticket, id);
	...
	<%
	if (!result) {
		out.println("<main><h1>No se pudo realizar la modificación debido a un error.</h1></main>");
	} else {
	%>

	<main>
		<h1>¡Modificaste tus tickets correctamente!</h1>

		<form class="ticket" action="update_tickets.jsp">
			...
			<div class="input-group">
				<span class="input-group-text bg-white">Nombre:</span> <input
